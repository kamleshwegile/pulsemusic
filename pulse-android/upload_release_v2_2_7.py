...
data = {
    ...
    "name": "Pulse Music Update v2.2.7",
    "body": "Jam Session Fixes (Queue sync, auto-transition broadcast fix, leave/delete bug, drift correction) & Brighter Navigation Icons.",
    "draft": False,
    "prerelease": False
}
...
if response.status_code == 201:
    ...
    upload_params = {"name": "PulseMusic-v2.2.7.apk"}
