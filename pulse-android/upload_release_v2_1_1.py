...
data = {
    ...
    "name": "Pulse Music Update v2.1.1",
    "body": "Added brand new download progress bar UI, silent background update checking, and automatic cache cleanup!",
    "draft": False,
    "prerelease": False
}
...
if response.status_code == 201:
    ...
    upload_params = {"name": "PulseMusic-v2.1.1.apk"}
