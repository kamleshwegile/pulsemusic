...
data = {
    ...
    "name": "Pulse Music Update v2.2.8",
    "body": "Fixes Jam Disconnects (Ping Interval) and adds proper Leave Jam functionality for participants.",
    "draft": False,
    "prerelease": False
}
...
if response.status_code == 201:
    ...
    upload_params = {"name": "PulseMusic-v2.2.8.apk"}
